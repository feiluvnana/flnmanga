...
class EntityMapper extends ClassMapperBase<Entity> {
  ...
  static EntityMapper ensureInitialized() {
    if (_instance == null) {
      ...
      ApiClientMapper.ensureInitialized();
...
class ApiClientMapper extends SubClassMapperBase<ApiClient> {
  ApiClientMapper._();

  static ApiClientMapper? _instance;
  static ApiClientMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(_instance = ApiClientMapper._());
  ...
  @override
  final String id = 'ApiClient';

  static Uuid _$id(ApiClient v) => v.id;
  static const Field<ApiClient, Uuid> _f$id = Field('id', _$id);
  static ApiClientAttributes _$attributes(ApiClient v) => v.attributes;
  static const Field<ApiClient, ApiClientAttributes> _f$attributes =
      Field('attributes', _$attributes);
  static List<Relationship> _$relationships(ApiClient v) => v.relationships;
  static const Field<ApiClient, List<Relationship>> _f$relationships =
      Field('relationships', _$relationships);

  @override
  final MappableFields<ApiClient> fields = const {
    #id: _f$id,
  ...
  @override
  final dynamic discriminatorValue = EntityType.api_client;
  @override
  late final ClassMapperBase superMapper = EntityMapper.ensureInitialized();

  static ApiClient _instantiate(DecodingData data) {
    return ApiClient(
        id: data.dec(_f$id),
  ...
  static ApiClient fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<ApiClient>(map);
  }

  static ApiClient fromJson(String json) {
    return ensureInitialized().decodeJson<ApiClient>(json);
  }
}

mixin ApiClientMappable {
  String toJson() {
    return ApiClientMapper.ensureInitialized()
        .encodeJson<ApiClient>(this as ApiClient);
  }

  Map<String, dynamic> toMap() {
    return ApiClientMapper.ensureInitialized()
        .encodeMap<ApiClient>(this as ApiClient);
  }

  ApiClientCopyWith<ApiClient, ApiClient, ApiClient> get copyWith =>
      _ApiClientCopyWithImpl<ApiClient, ApiClient>(
          this as ApiClient, $identity, $identity);
  @override
  String toString() {
    return ApiClientMapper.ensureInitialized()
        .stringifyValue(this as ApiClient);
  }

  @override
  bool operator ==(Object other) {
    return ApiClientMapper.ensureInitialized()
        .equalsValue(this as ApiClient, other);
  }

  @override
  int get hashCode {
    return ApiClientMapper.ensureInitialized().hashValue(this as ApiClient);
  }
}

extension ApiClientValueCopy<$R, $Out> on ObjectCopyWith<$R, ApiClient, $Out> {
  ApiClientCopyWith<$R, ApiClient, $Out> get $asApiClient =>
      $base.as((v, t, t2) => _ApiClientCopyWithImpl<$R, $Out>(v, t, t2));
}

abstract class ApiClientCopyWith<$R, $In extends ApiClient, $Out>
    implements EntityCopyWith<$R, $In, $Out> {
  ApiClientAttributesCopyWith<$R, ApiClientAttributes, ApiClientAttributes>
      get attributes;
  @override
  ...
  $R call(
      {Uuid? id,
      ApiClientAttributes? attributes,
      List<Relationship>? relationships});
  ApiClientCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}

class _ApiClientCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, ApiClient, $Out>
    implements ApiClientCopyWith<$R, ApiClient, $Out> {
  _ApiClientCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<ApiClient> $mapper =
      ApiClientMapper.ensureInitialized();
  @override
  ApiClientAttributesCopyWith<$R, ApiClientAttributes, ApiClientAttributes>
      get attributes =>
  ...
  @override
  ApiClient $make(CopyWithData data) => ApiClient(
      id: data.get(#id, or: $value.id),
      attributes: data.get(#attributes, or: $value.attributes),
      relationships: data.get(#relationships, or: $value.relationships));

  @override
  ApiClientCopyWith<$R2, ApiClient, $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
      _ApiClientCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
