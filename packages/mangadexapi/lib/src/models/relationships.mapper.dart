...
class RelationshipMapper extends ClassMapperBase<Relationship> {
  ...
  static RelationshipMapper ensureInitialized() {
    if (_instance == null) {
      ...
      ReasonRelationshipMapper.ensureInitialized();
...
class ReasonRelationshipMapper extends SubClassMapperBase<ReasonRelationship> {
  ReasonRelationshipMapper._();

  static ReasonRelationshipMapper? _instance;
  static ReasonRelationshipMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals.use(_instance = ReasonRelationshipMapper._());
      RelationshipMapper.ensureInitialized().addSubMapper(_instance!);
  ...
  @override
  final String id = 'ReasonRelationship';

  static Uuid _$id(ReasonRelationship v) => v.id;
  static const Field<ReasonRelationship, Uuid> _f$id = Field('id', _$id);
  static ReasonAttributes? _$attributes(ReasonRelationship v) => v.attributes;
  static const Field<ReasonRelationship, ReasonAttributes> _f$attributes =
      Field('attributes', _$attributes, opt: true);

  @override
  final MappableFields<ReasonRelationship> fields = const {
    #id: _f$id,
    #attributes: _f$attributes,
  };
  ...
  final String discriminatorKey = 'type';
  @override
  final dynamic discriminatorValue = RelationshipType.reason;
  @override
  late final ClassMapperBase superMapper =
      RelationshipMapper.ensureInitialized();

  static ReasonRelationship _instantiate(DecodingData data) {
    return ReasonRelationship(
        id: data.dec(_f$id), attributes: data.dec(_f$attributes));
  }
  ...
  static ReasonRelationship fromMap(Map<String, dynamic> map) {
    return ensureInitialized().decodeMap<ReasonRelationship>(map);
  }

  static ReasonRelationship fromJson(String json) {
    return ensureInitialized().decodeJson<ReasonRelationship>(json);
  }
}

mixin ReasonRelationshipMappable {
  String toJson() {
    return ReasonRelationshipMapper.ensureInitialized()
        .encodeJson<ReasonRelationship>(this as ReasonRelationship);
  }

  Map<String, dynamic> toMap() {
    return ReasonRelationshipMapper.ensureInitialized()
        .encodeMap<ReasonRelationship>(this as ReasonRelationship);
  }

  ReasonRelationshipCopyWith<ReasonRelationship, ReasonRelationship,
          ReasonRelationship>
      get copyWith => _ReasonRelationshipCopyWithImpl<ReasonRelationship,
          ReasonRelationship>(this as ReasonRelationship, $identity, $identity);
  @override
  String toString() {
    return ReasonRelationshipMapper.ensureInitialized()
        .stringifyValue(this as ReasonRelationship);
  }

  @override
  bool operator ==(Object other) {
    return ReasonRelationshipMapper.ensureInitialized()
        .equalsValue(this as ReasonRelationship, other);
  }

  @override
  int get hashCode {
    return ReasonRelationshipMapper.ensureInitialized()
        .hashValue(this as ReasonRelationship);
  }
}

extension ReasonRelationshipValueCopy<$R, $Out>
    on ObjectCopyWith<$R, ReasonRelationship, $Out> {
  ReasonRelationshipCopyWith<$R, ReasonRelationship, $Out>
      get $asReasonRelationship => $base.as(
          (v, t, t2) => _ReasonRelationshipCopyWithImpl<$R, $Out>(v, t, t2));
}

abstract class ReasonRelationshipCopyWith<$R, $In extends ReasonRelationship,
    $Out> implements RelationshipCopyWith<$R, $In, $Out> {
  ReasonAttributesCopyWith<$R, ReasonAttributes, ReasonAttributes>?
      get attributes;
  @override
  $R call({Uuid? id, ReasonAttributes? attributes});
  ReasonRelationshipCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(
      Then<$Out2, $R2> t);
}

class _ReasonRelationshipCopyWithImpl<$R, $Out>
    extends ClassCopyWithBase<$R, ReasonRelationship, $Out>
    implements ReasonRelationshipCopyWith<$R, ReasonRelationship, $Out> {
  _ReasonRelationshipCopyWithImpl(super.value, super.then, super.then2);

  @override
  late final ClassMapperBase<ReasonRelationship> $mapper =
      ReasonRelationshipMapper.ensureInitialized();
  @override
  ReasonAttributesCopyWith<$R, ReasonAttributes, ReasonAttributes>?
      get attributes =>
  ...
  @override
  ReasonRelationship $make(CopyWithData data) => ReasonRelationship(
      id: data.get(#id, or: $value.id),
      attributes: data.get(#attributes, or: $value.attributes));

  @override
  ReasonRelationshipCopyWith<$R2, ReasonRelationship, $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
      _ReasonRelationshipCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
